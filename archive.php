...
<HTML>
<HEAD>
<TITLE>jps4 beta : more than just pok&eacute;mon : news archives</TITLE>
...
<TD width=500>
<?php
if(isset($page)) {include("news/archives/$page");}
else {
	echo "<DIV class=head>News Archives</DIV><BR>";
	include("news/archives/news-archive.html");
;}
?>
</TD>
