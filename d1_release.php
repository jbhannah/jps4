...
<HTML>
<HEAD>
<TITLE>jps4 beta : more than just pok&eacute;mon : duel masters : et cetera : release dates</TITLE>
...
<TD width=500>
<DIV class=head>
Duel Masters Release Dates
</DIV>
<?php
include("d1/release.txt");
if(!isset($item)) { ?>
<P align=center>
...
<TR><TD><A href="d1_release.php?item=<?= $n+1; ?>"><?= $r['event']; ?></A></TD><TD><?= $r['date']; ?></TD><TD><?= $r['platform']; ?></TD></TR>
<?php ;} ?>
</TABLE>
<P>
<?php ;}
...
<?php if(isset($release[$item-1]['img'])) { ?><IMG src="d1/release/<?= $release[$item-1]['img']; ?>" alt="<?= $release[$item-1]['name']; ?>" align=left><?php ;} ?>
...
<P><A href="d1_release.php">Duel Masters Release Dates</A>
<?php ;} ?>
</TD>
